...
{
    // Plain field-by-field write, deliberately NOT a seqlock -- see shared_layout.h's comment
    // on the HP->LP config block for the full reasoning. volatile so the compiler can't
